...
**Maturity Stages:**
- **Foundation** — foundational capability, required before first production workload
- **Operational** — intermediate capability, required for scaling beyond initial workloads
- **Optimized** — advanced capability, required for enterprise-grade operations
...
### Workload Brief Template — Foundation
...
### Problem-Solution Fit Validation — Foundation
...
### Workload Type Classification — Foundation
...
### Success Criteria Definition — Foundation
...
### Cost Ceiling Setting — Foundation
...
### Structured Prompt Design — Foundation
...
### Prompt Version Control — Foundation
...
### Prompt Review Process — Operational
...
### Golden Dataset Creation — Foundation
...
### Multi-Dimensional Scoring — Foundation
...
### Automated CI-Based Evaluation — Operational
...
### Threshold-Based Gating — Operational
...
### Prompt Injection Testing — Foundation
...
### Output Format Override Testing — Foundation
...
### Information Exfiltration Attempts — Operational
...
### Extreme Input Testing — Foundation
...
### CI-Based Adversarial Blocking — Operational
...
### Gateway Integration — Operational
...
### Observability Configuration — Foundation
...
### Classification Verification — Foundation
...
### Post-Deployment Output Sampling — Foundation
...
### Quality Drift Detection — Operational
...
### Feedback Loop to Prompt Iteration — Operational
